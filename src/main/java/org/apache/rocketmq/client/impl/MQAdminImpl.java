...
//        long nearlyTime = MessageClientIDSetter.getNearlyTimeFromID(uniqKey).getTime();
//        nearlyTime = nearlyTime - 30 * 1000;

        long nearlyTime = 0L;

        QueryResult qr = queryMessageByUniqKey(topic, uniqKey, 32, nearlyTime, Long.MAX_VALUE);
//        QueryResult qr = queryMessageByUniqKey(topic, uniqKey, 32, MessageClientIDSetter.getNearlyTimeFromID(uniqKey).getTime() - 1000, Long.MAX_VALUE);
